const REV = 6,
       BRUSHES = ["web", "vmirrorweb", "hmirrorweb", "", "sketchy", "vmirrorsketchy", "hmirrorsketchy", "", "shaded", "vmirrorshaded", "hmirrorshaded", "", "simple", "vmirrorsimple", "hmirrorsimple", "", "chrome", "fur", "longfur", "", "squares", "ribbon", "", "circles", "grid", "testing"],
       USER_AGENT = navigator.userAgent.toLowerCase();

var //SCREEN_WIDTH = 800,
    //SCREEN_HEIGHT = 400,
	SCREEN_WIDTH = window.innerWidth, //ORIGINAL
    SCREEN_HEIGHT = window.innerHeight, // ORIGINAL
    BRUSH_SIZE = 1,
    BRUSH_PRESSURE = 1,
    COLOR = [0, 0, 0],
