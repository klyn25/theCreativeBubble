...
//		
//		   cg.addColorStop(.2, "rgb(red,green,blue)");
//		   
//		}
		
		grd.addColorStop(0.15, '#FF0000'); 
		grd.addColorStop(0.26, '#FF7F00'); 
		grd.addColorStop(0.38, '#FFFF00'); 
		grd.addColorStop(0.50, '#00FF00'); 
		grd.addColorStop(0.61, '#0000FF'); 
		grd.addColorStop(0.73, '#4B0082'); 
		grd.addColorStop(0.85, '#8F00FF');
