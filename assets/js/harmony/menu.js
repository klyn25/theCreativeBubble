...
Menu.prototype =
{
    ...
    init: function()
    {
		...
		this.sketch = document.createElement('a');
        this.sketch.className = 'button';
        this.sketch.innerHTML = '&larr; Back';
        this.sketch.style.marginRight = '16px';
		this.sketch.setAttribute('href', '/~kflick/php2/Fall2015/final/gallery/');
        this.container.appendChild(this.sketch);
        ...
        this.exportImage.textContent = 'Export';
        ...
        this.resetBrush.textContent = 'Reset Brush';
        ...
        this.clear.textContent = 'Clear Canvas';
